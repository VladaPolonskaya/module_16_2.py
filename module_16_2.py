...
async def user_id_page(user_id: int = Path(gt=1, lt=100, description='Enter User ID', examples='1')):
...
async def user_inform_page(username: Annotated[str, Path(min_length=5, max_length=20, description='Enter username', examples='Urban')],
                            age: Annotated[int,Path(gt=18, lt=120, description='Enter age', examples='24')]):
